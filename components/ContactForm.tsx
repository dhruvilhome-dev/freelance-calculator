      ...
      <div className="mx-auto max-w-3xl space-y-10">
        ...
        <div className="border-b border-white/10 pb-8">
          ...
          <p className="mt-3 text-base text-slate-300 leading-relaxed">
            Have questions about our calculation models, feedback on the user
            interface, or suggestions for additional niche calculators? We would
          ...
          <div className="rounded-3xl border border-white/10 bg-slate-900/80 p-6 space-y-6 md:col-span-1">
            <div>
              ...
              <p className="mt-2 text-sm font-semibold text-white">
                support@freelancecalcsuite.online
              </p>
            </div>
            ...
            <div>
              ...
              <p className="mt-1 text-xs text-slate-300 leading-relaxed">
                Our editorial and technical team typically replies within{" "}
            ...
            {state === "success" ? (
              <div className="rounded-2xl border border-emerald-500/30 bg-emerald-950/30 p-8 text-center space-y-3">
                ...
                <p className="text-xs text-slate-300 max-w-sm mx-auto">
                  Your message has been received. If your inquiry requires a
                  response, our support team will reach out to{" "}
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <div>
                  ...
                  >
                    <option value="calculator-feedback">
                      Calculator Feedback &amp; Bug Report
                    </option>
                    <option value="tax-methodology">
                      Tax Formula &amp; Methodology Question
                    </option>
                    <option value="feature-request">
                      Request a New Niche or State Calculator
                    </option>
                    <option value="partnership">
                      Partnership or Editorial Inquiry
                    </option>
                ...
                {state === "error" && (
                  <p className="rounded-xl border border-rose-500/30 bg-rose-950/30 px-4 py-3 text-xs text-rose-300">
                    {errorMsg}
                  </p>
                )}
                ...
                <button
                  ...
                  className="w-full rounded-xl bg-cyan-400 py-3 text-xs font-bold text-slate-950 hover:bg-cyan-300 transition-colors shadow-lg shadow-cyan-950/50 disabled:opacity-60 disabled:cursor-not-allowed"
                >
